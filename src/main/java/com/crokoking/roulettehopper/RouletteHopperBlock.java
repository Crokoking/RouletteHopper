...
public class RouletteHopperBlock extends ContainerBlock {
   ...
   public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState state, LivingEntity placer, ItemStack stack) {
      if (stack.hasDisplayName()) {
         ...
         if (tileentity instanceof RouletteHopperTileEntity) {
            ((RouletteHopperTileEntity)tileentity).setCustomName(stack.getDisplayName());
         }
      }
   ...
   public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
      if (worldIn.isRemote) {
         ...
         TileEntity tileentity = worldIn.getTileEntity(pos);
         if (tileentity instanceof RouletteHopperTileEntity) {
            player.openContainer((RouletteHopperTileEntity)tileentity);
   ...
   public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving) {
      if (!state.isIn(newState.getBlock())) {
         TileEntity tileentity = worldIn.getTileEntity(pos);
         if (tileentity instanceof RouletteHopperTileEntity) {
            InventoryHelper.dropInventoryItems(worldIn, pos, (RouletteHopperTileEntity)tileentity);
   ...
   public void onEntityCollision(BlockState state, World worldIn, BlockPos pos, Entity entityIn) {
      TileEntity tileentity = worldIn.getTileEntity(pos);
      if (tileentity instanceof RouletteHopperTileEntity) {
         ((RouletteHopperTileEntity)tileentity).onEntityCollision(entityIn);
      }
