...
public class RouletteHopperItemHandler extends InvWrapper
{
    private final RouletteHopperTileEntity hopper;

    public RouletteHopperItemHandler(RouletteHopperTileEntity hopper)
    {
        super(hopper);
        this.hopper = hopper;
    }
